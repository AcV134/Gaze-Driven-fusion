...
# use_gaze=True if you want to use gaze data for training, validation and inference. gaze_input=True if you want to use gaze data as input to the model.
# trainer.limit_val_batches=5 is used to limit the number of validation batches to 5 for faster validation. You can change this value as per your requirement.
