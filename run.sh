...
python tools/train.py resume.ckpt_path='/home/models/DISC/adl-project-gaze/outputs/DISC/DISC-v1-360/Gaze_ckpt/e4_miou0.1791.ckpt' validate=true trainer.devices=1
